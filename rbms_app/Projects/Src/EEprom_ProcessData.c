...
EEP_COM_CAL  ComCal =
{
    ...
    {130991, 130651,   0 }, // Charge Current Measure
    {130992, 131332,   0 }, // DisCharge Current Measure

    {3327,    17000,   0 },
    {3327,    17000,   0 },

    2000, 4000,              // CV_LVREF, CV_HVREF
    {  9889,  9889,  9894,  9896,  9895,  9893,  9896,  9885,    9890,  9890 },
    { 19795, 19791, 19793, 19793, 19793, 19788, 19794, 19784,   19781, 19781 }
};
