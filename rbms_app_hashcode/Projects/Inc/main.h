...
//  hfet.c
/////////////////////////////////////////////////////////////////////////////////////
#define BSP_DFET_ENABLE()         HAL_GPIO_WritePin(DFET_EN_GPIO_Port, DFET_EN_Pin, GPIO_PIN_RESET)
#define BSP_DFET_DISABLE()        HAL_GPIO_WritePin(DFET_EN_GPIO_Port, DFET_EN_Pin, GPIO_PIN_SET)
#define BSP_CFET_ENABLE()         HAL_GPIO_WritePin(CFET_EN_GPIO_Port, CFET_EN_Pin, GPIO_PIN_RESET)
#define BSP_CFET_DISABLE()        HAL_GPIO_WritePin(CFET_EN_GPIO_Port, CFET_EN_Pin, GPIO_PIN_SET)
...
#define BSP_DFET_ST()             HAL_GPIO_ReadPin(DFET_EN_GPIO_Port, DFET_EN_Pin)
#define BSP_CFET_ST()             HAL_GPIO_ReadPin(CFET_EN_GPIO_Port, CFET_EN_Pin)
