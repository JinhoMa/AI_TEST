...
;*******************************************************************************
;*******************************************************************************
;* File Name    : stl_RL78_RamTest_Stacks_c.asm
;* Version      : 3.00
;* Device(s)    : RL78 (Test device used RL78/G14)
;* Tool-Chain   : RL78 CC-RL V1.08.00
;* OS           : None
;* H/W Platform : RL78/G14 Target Board
;* Description  : RL78 IEC Self Test Library Stack test by March C assembler module
...
.EXTERN  _stl_RL78_march_c
$IF (__RENESAS_VERSION__ >= 0x01010000)
$ELSE	; for CC-RL V1.00
.EXTRN	_stacktop
$ENDIF

     .PUBLIC  _stl_RL78_RamTest_Stacks_c            ; Global Name Declaration
...
;******************************************************************************
;* Start of stl_RL78_RamTest_Stacks_c.asm code
_stl_RL78_RamTest_Stacks_c:
...
;
    ...
    CALL    !!_stl_RL78_march_c     ; Test of stack evacuation area
    MOV     C,A
    CMP     A,#0
...
;
    ...
    CALL    !!_stl_RL78_march_c     ; Test of stack area
