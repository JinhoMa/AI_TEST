...
* 02.09.2019 V2.10 CC-RL Added AD Test
* 27.09.2019 V3.00 Extened Version
*******************************************************************************/
#include "iodefine.h" 
#include "globaldefines.h"

#ifdef ad_test_enabled
#include "stl_adc.h"
#endif
...
/* Port Settings for status LEDs on application/target board */
	...
	P7_bit.no5 = 1U;         /* Led1 Off */
	P7_bit.no6 = 1U;         /* Led2 Off */
	PM7_bit.no5 = 0U;        /* Led 1 output */
	PM7_bit.no6 = 0U;        /* Led 2 output */
#else
